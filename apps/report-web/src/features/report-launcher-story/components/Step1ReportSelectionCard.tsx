...
const summaryInfoCardClassName = 'bg-slate-50 h-36 overflow-y-auto';
const listScrollAreaClassName =
  'min-h-0 flex-1 overflow-y-auto pr-1 pb-1 max-h-[50vh] md:max-h-[calc(100vh-30rem)]';
...
export function Step1ReportSelectionCard({
  ...
  return (
    ...
    >
      <div className="h-full min-h-0 p-4 sm:p-6 flex flex-col">
        <div className="min-h-0 flex-1 overflow-y-auto pr-1 pb-3">
          <Stack gap="lg" className="h-full min-h-0">
            ...
            <div className="min-h-0 flex-1">
              <div className="grid min-h-0 grid-cols-1 gap-4 pb-1 md:h-full md:grid-cols-2 md:items-stretch">
                <Paper
                  withBorder
                  radius="md"
                  p="md"
                  className="min-h-0 bg-white/80 flex flex-col overflow-hidden md:h-full"
                >
                  <Stack gap="sm" className="h-full min-h-0">
                    ...
                    <div className={listScrollAreaClassName}>
                      <Stack gap="sm">
